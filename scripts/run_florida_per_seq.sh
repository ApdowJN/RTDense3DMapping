...
# Data paths
DATA_PATH=/home/wangweihan/Documents/my_project/underwater_project/dataset/Florida/
OUTPUT_PATH=/home/wangweihan/Documents/my_project/underwater_project/dataset/Output/Florida_per_seq/

#DATA_PATH=/media/nate/Data/NSF/Florida/
#OUTPUT_PATH=/media/nate/Data/NSF/Output/Florida/
...
#python merge_point_clouds.py ${OUTPUT_PATH}point_clouds/ 0 ${OUTPUT_PATH}florida_unfiltered.ply
#python merge_point_clouds.py ${OUTPUT_PATH}point_clouds/ 1 ${OUTPUT_PATH}florida_filtered.ply
