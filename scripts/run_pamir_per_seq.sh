...
# Data paths
DATA_PATH=/home/wangweihan/Documents/my_project/underwater_project/dataset/Pamir/
OUTPUT_PATH=/home/wangweihan/Documents/my_project/underwater_project/dataset/Output/Pamir_per_seq/

#DATA_PATH=/media/nate/Data/NSF/Pamir/
#OUTPUT_PATH=/media/nate/Data/NSF/Output/Pamir/
...
#	python merge_point_clouds.py ${OUTPUT_PATH}point_clouds/ 0 ${OUTPUT_PATH}pamir_unfiltered.ply
# python merge_point_clouds.py ${OUTPUT_PATH}point_clouds/ 1 ${OUTPUT_PATH}pamir_filtered.ply
