...
# Data paths
DATA_PATH=/home/wangweihan/Documents/my_project/underwater_project/dataset/Mexico/
OUTPUT_PATH=/home/wangweihan/Documents/my_project/underwater_project/dataset/Output/Mexico_per_seq/

#DATA_PATH=/media/nate/Data/NSF/Mexico/
#OUTPUT_PATH=/media/nate/Data/NSF/Output/Mexico/
...
BUILD_DIR=../build/
EXE_NAME=accelerated_depth_fusion
...
build_exe() {
    ...
    cd ${1}
	rm ${EXE_PATH} 2> /dev/null #avoid warning
...
#python merge_point_clouds.py ${OUTPUT_PATH}point_clouds/ 0 ${OUTPUT_PATH}mexico_unfiltered.ply
# python merge_point_clouds.py ${OUTPUT_PATH}point_clouds/ 1 ${OUTPUT_PATH}mexico_filtered.ply
